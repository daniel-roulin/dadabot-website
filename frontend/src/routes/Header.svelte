<header>
    <div class="header-items">
        <form action="#" class="search">
            <input type="text" placeholder="Search chapters.." name="search">
    ...
            </button>
        ...
        <a href="/">
            <img class="logo" alt="Dadabot logo" src="https://ssl.gstatic.com/images/branding/product/1x/drive_2020q4_48dp.png">
        </a> 
        <a class="title" href="/">Dadabot</a>        
    </div>
    <hr class="divider">
</header>
